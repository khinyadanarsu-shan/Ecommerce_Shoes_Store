...
if (isset($_SESSION['username'])) {
  ...
  if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (!empty($newPassword)) {
      $isStrong = preg_match('/[A-Z]/', $newPassword) &&
      ...
      if ($isStrong) {
        ...
        $_SESSION['password_modal_alert'] = [
          'type' => 'danger',
          'message' => 'Password is not strong enough. Must contain at least 8 characters, upper & lowercase letters, number, and special character.'
        ];
